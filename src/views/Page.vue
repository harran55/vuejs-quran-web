  ...
  <div class="page container">
    <div class="row">
      ...
      <div class="col-12 text-center">
        <h3>مميزات وخصائص التطبيق</h3>
        <p>
          التطبيق خفيف جداً وسهل التصفحة
        </p>
      </div>
      ...
      <div class="col-4 col-md-3">
        ...
        <p>
          حفظ رقم الصفحة ورقم الآية التي توقفت عندها
        </p>
        </div>
      </div>
      ...
      <div class="col-4 col-md-3">
        ...
        <p>
          تكرار قراءة الآية بالعدد الذي تدخلة
        </p>
        </div>
      </div>
      ...
      <div class="col-4 col-md-3">
        ...
        <p>
          الانتقال الى الصفحة الآخر بعد الانتهاء من قراءة الصفحة تلقائي
        </p>
        </div>
      </div>
      ...
      <div class="col-4 col-md-3">
        <div class="card">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-cursor-text" viewBox="0 0 16 16">
      ...
      <div class="col-4 col-md-3">
        ...
        <p>
          تسهيل عملية البحث برقم الصفحة او بحروف من السورة
        </p>
        </div>
      </div>
